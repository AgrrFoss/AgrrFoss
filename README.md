...
В процессе обучения мы использовали командную строку ![Git](https://img.shields.io/badge/git-%23F05033.svg?style=for-the-badge&logo=git&logoColor=white)
 для работы с репозиториями на Github, знаю как работать с различными ветками и в команде.
